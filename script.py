# First, let's create an updated version of the corrected Flask app with Urban Platter branding
# and ensure all requested changes are implemented

updated_flask_app = '''#!/usr/bin/env python3
"""
...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///urban_platter.db')
...
with open("urban_platter_app.py", "w", encoding="utf-8") as f:
    f.write(updated_flask_app)

print("✅ Urban Platter Flask app created!")
print("\n🏢 Restaurant Name: Urban Platter")
print("💰 Currency: ₹ (Indian Rupees)")
print("🍽️  60 menu items (15 in each category)")
